...
sample_data_file <- function() {
    ...
    if (!file.exists("./final/de_DE/de_DE.blogs.sample.txt")) {
        ...
        system(
            ...
            cd ..;
            cd ./en_US;
            gshuf -n 2000 en_US.blogs.txt > en_US.blogs.sample.txt;
            gshuf -n 2000 en_US.news.txt > en_US.news.sample.txt;
            gshuf -n 2000 en_US.twitter.txt > en_US.twitter.sample.txt;
            rm en_US.blogs.txt;
            rm en_US.news.txt;
